...
import 'package:amazonn/common/widgets/custom_button.dart';
import 'package:amazonn/common/widgets/custom_textfield.dart';
...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  void sellProduct(){
    if(_addProductFormKey.currentState!.validate()&& iamges.isNotEmpty ){
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                iamges.isNotEmpty ?  CarouselSlider(
      items: iamges.map((i){
        return Builder(
